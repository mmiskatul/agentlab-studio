    ...
    <DashboardLayout>
      <div className="p-6 lg:p-8 space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button className="gradient-primary text-primary-foreground gap-2"><Save className="h-4 w-4" /> Save Agent</Button>
        </div>
        ...
        <Tabs defaultValue="basic" className="space-y-6">
          ...
          <TabsContent value="basic">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="glass-card rounded-xl p-6 shadow-card space-y-5">
          ...
          <TabsContent value="prompt">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="glass-card rounded-xl p-6 shadow-card space-y-5">
              <div className="space-y-2">
                ...
                <Textarea placeholder="You are a helpful AI assistant..." rows={8} className="font-mono text-sm" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium">Task Rules</label>
                <Textarea placeholder="1. Always be polite&#10;2. Ask clarifying questions&#10;3. Provide sources" rows={5} />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium">Tone</label>
                <Select><SelectTrigger><SelectValue placeholder="Select tone" /></SelectTrigger>
                  <SelectContent>
