    ...
    setTimeout(() => {
      setMessages((m) => [
        ...m,
        {
          role: "ai",
          content:
            "That's a great question! Let me help you with that. Based on my analysis, here's what I recommend...",
        },
      ]);
      setTyping(false);
    }, 1500);
          ...
          <div className="flex-1 overflow-auto p-6 space-y-4">
            ...
            {typing && (
              <div className="flex gap-3">
                <div className="gradient-primary rounded-lg p-1.5 h-8 w-8 flex items-center justify-center">
                  <Bot className="h-4 w-4 text-primary-foreground" />
                </div>
