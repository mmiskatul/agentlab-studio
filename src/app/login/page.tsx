...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-body relative overflow-hidden text-slate-900">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-indigo-400/10 rounded-full blur-[120px] pointer-events-none mix-blend-multiply"></div>
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[440px] relative z-10">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="#" className="font-semibold text-xs text-blue-600 hover:text-blue-500 transition-colors">
        ...
        <p className="mt-8 text-center text-[15px] font-medium text-slate-500">
          ...
          <Link href="/register" className="font-bold text-blue-600 hover:text-blue-700 transition-colors hover:underline underline-offset-4">
            Sign up for free
          </Link>
        </p>
      </div>
